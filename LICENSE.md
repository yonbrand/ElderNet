In this study, we utilized the pre-trained UK Biobank SSL model. For its implementation, we used the model architecture from the following repository: (https://github.com/OxWearables/ssl-wearables/tree/main).  
